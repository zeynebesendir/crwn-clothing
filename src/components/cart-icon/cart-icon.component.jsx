...
-even if the user state changes(which is irrelevent for this component), this mapStateToProps still will be triggered
...
Solution:
    Use reselect that will allow us to memoize (caching the value) and not re-render a component if the state value does not change.
    *yarn add reselect
